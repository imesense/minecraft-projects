 ...
 *
 */
public final class IParserSingleScriptSettingsCache implements IParser
{
    /**
     *
     */
    public IParserSingleScriptSettingsCache()
    {
    ...
    {
        File file = getConfigFile(initialization, DynamicSpawnControlStructure.STRUCT_FILES_DIRS.NAME_DIR_CACHE,
                /*EnumSingleScript.SCRIPT_CACHE_MOBS.getKeyword()*/"cache_mobs.json");
