...
@Mixin(value = EntityTwins.class, remap = false)
public abstract class EntityTwinsRework extends EntityMob
{
    @Unique
    ...
    public EntityTwinsRework(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, false)
        {
            ...
            public void startExecuting()
            {
                ...
                {
                    ((EntityTwinsRework) this.taskOwner).setPersistentAttacker((EntityPlayer) attacker);
                }
            }
        });
