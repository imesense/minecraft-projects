...
public class SpawnerCraftRecipes {
    public static void registerRecipes() {
        ...
        ForgeRegistries.RECIPES.register(new NBTPreservingShapedRecipe(SpawnerCraft.MOD_ID,
        ...
        if (ConfigHandler.spawnerCraftable) {
            GameRegistry.addShapedRecipe(new ResourceLocation(SpawnerCraft.MOD_ID,
