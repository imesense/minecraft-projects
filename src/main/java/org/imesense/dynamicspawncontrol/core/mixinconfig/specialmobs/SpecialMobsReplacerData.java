...
public final class SpecialMobsReplacerData
{
    ...
    public static void loadFromFile(String filePath)
    {
        try
        {
            ...
            if (configFile.exists())
            {
                ...
                EarlyLogBuffer.log(LogManager.WARN,
    ...
    public static void resetToDefault()
    {
        ...
        EarlyLogBuffer.log(LogManager.INFO, "Reset SpecialMobs replacer config to default: false");
    }

    public static void setReplaceVanilla(boolean value)
    {
        replaceVanilla = value;
        EarlyLogBuffer.log(LogManager.INFO, "SpecialMobs replacer config set to: " + value);
    }
}
