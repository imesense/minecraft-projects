...
import org.imesense.dynamicspawncontrol.core.api.AbstractConceptBaseConfigRegister;
...
public final class RegisterConfig extends AbstractConceptBaseConfigRegister
{
    private static volatile RegisterConfig _INSTANCE;
