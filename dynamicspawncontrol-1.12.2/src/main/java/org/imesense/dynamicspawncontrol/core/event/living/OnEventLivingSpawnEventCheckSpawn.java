...
import org.imesense.dynamicspawncontrol.core.script.processor.OnEventEntityWorldCache;
...
public final class OnEventLivingSpawnEventCheckSpawn extends BaseOnEventInstance
{
    ...
    {
        OnEventEntityWorldCache.getInstance().handleLivingSpawnEventCheckSpawn(event);
    }
