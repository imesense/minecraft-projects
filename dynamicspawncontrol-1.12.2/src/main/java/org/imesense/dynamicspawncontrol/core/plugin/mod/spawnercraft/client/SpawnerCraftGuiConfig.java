...
public class SpawnerCraftGuiConfig extends GuiConfig {
    public SpawnerCraftGuiConfig(GuiScreen guiScreen) {
        super(guiScreen, getConfigElements(), DynamicSpawnControlStructure.STRUCT_INFO_MOD.MOD_ID, false, false, GuiConfig.getAbridgedConfigPath(ConfigHandler.config.toString()));
    }
