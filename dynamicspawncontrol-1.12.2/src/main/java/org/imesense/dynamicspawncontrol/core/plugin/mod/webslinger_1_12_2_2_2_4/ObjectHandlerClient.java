package org.imesense.dynamicspawncontrol.core.plugin.mod.webslinger_1_12_2_2_2_4;
...
public final class ObjectHandlerClient
{
    ...
    public static Item ItemWebbing = null;
    ...
    public static class RegistrationHandler extends RegistrationHelper
    {
        ...
        public static void registerItems(Register<Item> event)
        {
            ...
            ObjectHandlerClient.ItemWebbing = regHelper(registry, new ItemWebbing());
        }
        ...
        {
            registerRender(ObjectHandlerClient.ItemWebbing);

            RenderingRegistry.registerEntityRenderingHandler(EntityWebbing.class, (manager) ->
                    new RenderSnowball<>(manager, ObjectHandlerClient.ItemWebbing, UniqueField.CLIENT.getRenderItem()));
        }
